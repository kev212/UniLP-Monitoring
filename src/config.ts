...
const envSchema = z.object({
  ...
  POOL_SCAN_MIN_VOLUME_1H_USD: z.coerce.number().nonnegative().default(0),
...
export function loadConfig(environment = process.env): RuntimeConfig {
  ...
  return {
    ...
    poolScanDefaults: {
      ...
      minVolume1hUsd: env.POOL_SCAN_MIN_VOLUME_1H_USD,
      minStockPoolVolume1hUsd: env.POOL_SCAN_MIN_STOCK_POOL_VOLUME_1H_USD,
